...
const examTemplates = [
  // --- TEF CANADA TEMPLATES ---
  {
    id: "tef-eo-section-a",
    section: "EO_SectionA",
    examType: "TEF_Canada",
    title: "TEF Canada: Expression Orale - Section A (Inquiry / Gathering Info)",
    timeLimitMinutes: 5,
    ...
    gradingCriteria: [
      ...
      "Politeness and consistent use of VOUS (Formal register)",
  ...
  },
  {
    ...
    section: "EO_SectionB",
    examType: "TEF_Canada",
    title: "TEF Canada: Expression Orale - Section B (Persuading a Friend)",
    timeLimitMinutes: 10,
  ...
  },
  {
    ...
    section: "EE_SectionA",
    examType: "TEF_Canada",
    title: "TEF Canada: Expression Écrite - Section A (Fait Divers / ~100 words)",
    timeLimitMinutes: 15,
  ...
  },
  {
    ...
    section: "EE_SectionB",
    examType: "TEF_Canada",
    title: "TEF Canada: Expression Écrite - Section B (Formal Argumentative Letter)",
    timeLimitMinutes: 45,
  ...
  // --- TCF CANADA TEMPLATES ---
  {
    id: "tcf-eo-task-2",
    section: "TCF_EO_Task2",
    examType: "TCF_Canada",
    title: "TCF Canada: Expression Orale - Tâche 2 (Interaction & Inquiry / 3.5 mins)",
    timeLimitMinutes: 4,
    objective: "Simulate a real-life situation where you must ask questions to obtain information from the examiner (can be formal VOUS or informal TU depending on prompt).",
    structuralFormula: [
      "1. Identify the relationship (Clerk = VOUS, Colleague/Friend = TU).",
      "2. Ask 5-8 targeted questions regarding requirements, pricing, location, dates.",
      "3. React naturally to the examiner's answers (e.g. \"Ah, d'accord ! C'est bon à savoir.\")."
    ],
    essentialConnectors: [
      { french: "Est-ce qu'il serait possible de...", english: "Would it be possible to...", example: "Est-ce qu'il serait possible d'avoir un reçu détaillé ?" },
      { french: "Pourriez-vous m'indiquer...", english: "Could you tell me...", example: "Pourriez-vous m'indiquer où se déroule la réunion ?" }
    ],
    modelScriptSnippet: "\"Bonjour Monsieur ! J'ai vu votre offre d'emploi pour un poste de développeur à Québec. Je me permets de vous poser quelques questions. Pourriez-vous me préciser si le télétravail est envisageable ?...\"",
    samplePrompt: "Vous souhaitez vous inscrire à un club de sport à Montréal. Vous posez des questions au responsable.",
    gradingCriteria: [
      "Appropriate register (Tu vs Vous)",
      "Spontaneous reactions to examiner replies",
      "Fluid interrogative structures"
    ]
  },
  {
    id: "tcf-eo-task-3",
    section: "TCF_EO_Task3",
    examType: "TCF_Canada",
    title: "TCF Canada: Expression Orale - Tâche 3 (Expressing a Stance without prep / 4.5 mins)",
    timeLimitMinutes: 5,
    objective: "Present a continuous, structured point of view on a general topic (e.g. artificial intelligence, climate change, mandatory public transit) and answer examiner follow-ups.",
    structuralFormula: [
      "1. Introduction: State the issue and your nuanced thesis.",
      "2. Perspective 1 (Benefits / Strengths) with real-world example.",
      "3. Perspective 2 (Risks / Limits) with counter-analysis.",
      "4. Synthesis & Conclusion: Offer balanced resolution."
    ],
    essentialConnectors: [
      { french: "À mon humble avis...", english: "In my humble opinion...", example: "À mon humble avis, l'innovation technologique doit être encadrée." },
      { french: "Il convient de souligner que...", english: "It should be emphasized that...", example: "Il convient de souligner que les retombées économiques sont positives." },
      { french: "Néanmoins...", english: "Nevertheless...", example: "Néanmoins, il ne faut pas négliger les risques pour la vie privée." }
    ],
    modelScriptSnippet: "\"À mon avis, le télétravail généralisé présente d'immenses avantages tant pour les employés que pour les entreprises. D'un côté, il permet de réduire considérablement le temps passé dans les transports quotidiens. Toutefois, il est indispensable de veiller au maintien de la cohésion sociale au sein des équipes...\"",
    samplePrompt: "Faut-il limiter l'usage des réseaux sociaux chez les jeunes de moins de 16 ans ? Donnez votre avis argumenté.",
    gradingCriteria: [
      "Fluency without long hesitation pauses",
      "Depth of nuanced arguments (B2 requires balanced synthesis)",
      "Accurate subjunctive and conditional constructions"
    ]
  }
];

fs.writeFileSync(path.join(__dirname, 'src', 'data', 'examTemplates.json'), JSON.stringify(examTemplates, null, 2), 'utf8');
console.log('Successfully generated full TEF vs TCF Canada exam templates!');
